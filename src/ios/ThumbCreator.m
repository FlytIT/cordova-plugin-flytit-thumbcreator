...
- (void)createThumb:(CDVInvokedUrlCommand *)command {
    ...
    NSString *targetFilePaht = [NSString stringWithFormat:@"%@_thumb_%@",stringToPath,[stringFromPath lastPathComponent]];

    NSURL *targetFileUrl =[NSURL fileURLWithPath:targetFilePaht];
    ...
    if(success) {
        ...
        NSDictionary* ret = @{
            ...
            @"absolutePath": targetFileUrl.absoluteString,
